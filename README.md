...
The repository now supports .txt .rtf .pdf .docx .csv .avro .json formats and parsing data from tags(p, h, b, big, small, i, strong, sub, sup, ins, del, th, span, img, video, audio) of standart web pages.
